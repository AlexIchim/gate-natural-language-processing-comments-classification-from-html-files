...
public class Main {
	...
	public static void main(String[] args) throws GateException, IOException {
		...
		SerialAnalyserController sac = LoadPRClass.getProcessingResources();

		// get location of directory containing all files and obtain path of all files
		File loc = new File("src/data/testdata");
		...
		DocumentProcessorClass.processDocuments(sac, allFiles, rows, 500);
		
		// call file writer to write the CSV file
		WriteXLSClass.csvWriter(allFiles.length, rows);
